...
impl RecordLayer {
    ...
    pub(crate) fn decrypt_incoming<'p>(
        &mut self,
        encr: BorrowedOpaqueMessage<'p>,
    ) -> Result<Option<Decrypted<'p>>, Error> {
...
pub(crate) struct Decrypted<'p> {
    ...
    pub(crate) plaintext: BorrowedPlainMessage<'p>,
}
